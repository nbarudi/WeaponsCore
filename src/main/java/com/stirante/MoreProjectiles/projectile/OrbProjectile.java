    ...
    public void t_() {
        ...
        if (movingobjectposition != null) {
            if (movingobjectposition.type == MovingObjectPosition.EnumMovingObjectType.BLOCK && !isIgnored(world.getWorld().getBlockAt(movingobjectposition.a().getX(), movingobjectposition.a().getY(), movingobjectposition.a().getZ()).getType())) {
                CustomProjectileHitEvent event = new CustomProjectileHitEvent(this, world.getWorld().getBlockAt(movingobjectposition.a().getX(), movingobjectposition.a().getY(), movingobjectposition.a().getZ()), CraftBlock.notchToBlockFace(movingobjectposition.direction));
