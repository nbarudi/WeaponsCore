...
import ca.bungo.utils.Cooldowns;
...
public class PianoKey extends BallerItem
{
    ...
    {
        ((CraftPlayer)p).getHandle().playerConnection.sendPacket(new PacketPlayOutWorldEvent(1005, new BlockPosition(loc.getBlockX(), loc.getBlockY(), loc.getBlockZ()), record, false));
    }
