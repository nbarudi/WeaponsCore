...
public class Prot4 extends BallerItem
{
	...
	private static List<String> lore()
	{
		...
		{{
			this.add(ChatColor.DARK_GRAY + "Authentic Protection 4 Armor");
		}};
	}
