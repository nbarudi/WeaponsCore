...
public class FortyFoot extends BallerItem
{
	Core plugin;
	ArrayList<Entity> arrows = new ArrayList<Entity>();
	public FortyFoot(Core core)
	{
		super(ChatColor.AQUA + "THE 40 FOOT CUMSHOT", Material.BOW, 100000, lore(), enchantments(), "40footcumshot", "40foot", "40ft", "cumshots");
		this.plugin = core;
